 ...
 * @returns {JSX.Element} A React element that renders the circular progress indicator with a label.
 *
 * @example
 * // Example usage of CircularProgressWithLabel:
 * <CircularProgressWithLabel label="Loading..." color="primary" size={50} />
 */
function CircularProgressWithLabel(props: CircularProgressProps & { label: string }): JSX.Element {
  return (
